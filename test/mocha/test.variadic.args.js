...
describe('variadic.args', function () {
  it('assigns all final arguments to variadic argument array', function () {
    program
      .version('0.0.1')
  ...
  it('doesn\'t test no arguments to fill variadic arg');
  it('shows error if variadic argument is not last', function () {
    program
      .version('0.0.1')
